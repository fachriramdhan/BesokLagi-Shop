...
export default function DropSection({ addToCart }: DropSectionProps) {
  return (
    <section id="drop" className="py-20 bg-[#050505] overflow-hidden">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-4" data-aos="fade-up">
          <div className="space-y-1">
            ...
            <h2 className="font-brutal text-4xl md:text-5xl uppercase tracking-tighter text-white">
              Current <span className="text-blue-600 italic">Drop</span>
            </h2>
          </div>
          <span className="text-[8px] font-bold tracking-[0.2em] border border-white/10 px-3 py-1.5 uppercase text-gray-500">
            EST. 2026 © IDENTITY
          </span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto">
          {products.map((product, index) => (
            ...
            >
              <div className="relative overflow-hidden bg-zinc-900 aspect-[4/5] border border-white/5">
                {product.tag && (
                  <div
              ...
              <div className="mt-5 space-y-3">
                <div className="flex justify-between items-start">
                  <div>
                    <h3 className="font-brutal text-xl uppercase tracking-tighter text-white leading-none">
                      {product.name}
                    </h3>
                ...
                <button
                  ...
                  className="group/btn relative w-full inline-flex items-center justify-center gap-3 py-3 border border-white/10 hover:border-blue-600 transition-all duration-500 overflow-hidden bg-white/5"
                >
                  <span className="text-[8px] font-bold uppercase tracking-[0.2em] relative z-10 text-white">
                    Add to Cart
                  </span>
                  ...
                  <i className="fa-solid fa-plus text-[8px] relative z-10 text-white"></i>
                </button>
              </div>
            </div>
          ))}
